...
public class TarotDealerUI : MonoBehaviour 
{
	private TarotDealer _dealer;
	...
	private void Awake()
	{
		_dealer = GameObject.Find("Dealer").GetComponent<TarotDealer>();
		_dealer.TarotDealerUIInstance = this;
	}
